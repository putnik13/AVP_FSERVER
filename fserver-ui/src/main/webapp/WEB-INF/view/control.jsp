...
<body>
	...
	<table>
		<tr>
			<td valign="top" style="padding-top: 200px; padding-left: 40px;">
				<nav>
					<ul class="nav nav-pills nav-stacked span2">
						...
						<c:if test="<%=!authorities[0].toString().equals("ROLE_ADMIN")%>">
							<li class="disabled"><a
								href='<c:url value="/system"></c:url>'>Network Settings</a></li>
							<li class="disabled"><a
								href='<c:url value="/fconfig"></c:url>'>System Settings</a></li>
						</c:if>
					</ul>
				</nav></td>
